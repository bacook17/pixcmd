...
###############################################
# CONFIG FILE for MODEL-MISMATCH mock run #4
# MOCK Galaxy:
#    Metallicity Model: Single
#            [Fe/H] = -0.25
#    Dust Model:        Fixed-Wdith (0.1) LogNorm (Fdust = 0.5)
#        log E(B-V) = -0.5
#    SFH Model: Tau
#              Npix = 2.0
#              tau  = 3.0
...
# dustmodel = ppy.dustmodels.FixedWidthLogNormDust(0.1, dust_frac=0.5)  # fixed width lognorm
...
dustmodel = ppy.dustmodels.FixedWidthLogNormDust(0.1, dust_frac=0.5)
sfhmodel = sfhmodel
distancemodel = ppy.distancemodels.VariableDistance()  # dmod floats
