...
###############################################
# CONFIG FILE for mock run #6
# MOCK Galaxy:
#    Metallicity Model: Full MDF
#            [Fe/H] = -0.25
#             sigma = 0.2
#    Dust Model:        Fixed-Width LogNormal (Fdust = 0.5)
#        log E(B-V) = -0.5
#             sigma = 0.1
#    SFH Model: Tau
#              Npix = 2.0
...
sigz_bound = [0.02, 0.4] # metallicity width

dust_med_bound = [-1.0, 0.0]  # log dust
dust_sig_bound = [0.02, 0.4]  # dust width
...
prior_bounds['dust_bounds'] = [dust_med_bound, dust_sig_bound]
...
gal_params = np.array([feh, sig_feh, log_ebv, sig_dust, log_npix, tau, dmod])
