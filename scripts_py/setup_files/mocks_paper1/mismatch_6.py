...
###############################################
# CONFIG FILE for MODEL-MISMATCH mock run #6
#    MISTMATCH in distance
# MOCK Galaxy:
...
#
# MODEL Galaxy:
#      Fixed-Width MDF Metallicity Model
# Priors:
#           [Fe/H] : [-0.5, 0.25]
#       log E(B-V) : [-1.0, 0.0]
#             Npix : [1.0, 5.0]
...
# Distance model
distancemodel = ppy.distancemodels.FixedDistance(28.0)  # fixed dmod=28.0
