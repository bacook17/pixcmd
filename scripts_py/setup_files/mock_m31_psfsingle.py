...
#                 tau = 3.1
#                dmod = 29.2
# MODEL Galaxy: Tau model, fixed MDF, fixed dust width, variable distance
...
gal_params = np.array([-0.1, -1.7, 3.0, 3.5, 24.42])
model_mock.set_params(gal_params)

# Create the mock data
# temporary driver to make mock
f = ppy.instrument.m31_narrow_psf(F475W=False)
