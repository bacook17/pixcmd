...
###############################################
# SETUP FILE for DYNESTY Test #2
# Npix = 1e3, Nim = 1024, Npoints=50, Gal=const, LL=binned
...
model_class = gal.Constant_SFR # Constant SFR model
