# setup_files/data_m51_tau_IVB.py
# Ben Cook (bcook@cfa.harvard.edu)

###############################################
# SETUP FILE for Data Test with tau model and ALL THREE BANDS
# DATA: M51
...
params['filters'] = instrument.m51_filters(dist=d_mpc)
...
BV_bins = np.arange(-2.5, 6., 0.05)
BI_bins = np.arange(-2.5, 6., 0.05)
params['bins'] = np.array([I_bins, BV_bins, BI_bins])
