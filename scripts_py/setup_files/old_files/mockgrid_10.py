# mockgrid_dust_const.py configuration file
# Ben Cook (bcook@cfa.harvard.edu)

###############################################
# CONFIG FILE for mock test
# MOCK Galaxy: has rising (tau=-1) SFH, gaussian MDF
