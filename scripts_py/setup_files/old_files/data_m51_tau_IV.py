# setup_files/data_m51_tau_IV.py
# Ben Cook (bcook@cfa.harvard.edu)

###############################################
# SETUP FILE for Data Test with tau model, using I and V bands
# DATA: M51
...
params['filters'] = [instrument.ACS_WFC_F814W(d_mpc),
                     instrument.ACS_WFC_F555W(d_mpc)]
...
params['bins'] = np.array([I_bins, BV_bins])
