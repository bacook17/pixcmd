# M87 Model 7 (NonParam, Free, Single)
# Ben Cook (bcook@cfa.harvard.edu)

###############################################
# CONFIG FILE for M87 Model 7
# MODEL Galaxy:
#    Single FeH
#    Single Dust
#    NonParam SFH
...
params['filters'] = ppy.instrument.m87_filters_v2()
...
# Distance model
distancemodel = ppy.distancemodels.FixedDistance(30.9)  # fixed dmod=31
