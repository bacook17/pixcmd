# NGC3377 Model 22 (NonParam, Fixed, Single)
# Ben Cook (bcook@cfa.harvard.edu)

###############################################
# CONFIG FILE for NGC3377 Model 22
# MODEL Galaxy:
#    Single FeH
#    Single Dust
#    NonParam SFH
...
params['filters'] = ppy.instrument.default_ngc3377_filters()
...
# Distance model
distancemodel = ppy.distancemodels.FixedDistance(30.18)  # fixed dmod=24.42 (766 kpc)
