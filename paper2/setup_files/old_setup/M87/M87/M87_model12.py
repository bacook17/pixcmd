# M87 Model 9 (Tau Model, Narrow Mu Prior)
# Ben Cook (bcook@cfa.harvard.edu)

###############################################
# CONFIG FILE for M87 Model 9
# MODEL Galaxy:
#    Single FeH
#    Single Dust
#    SSP SFH
...
params['filters'] = ppy.instrument.lowexp_m87_filters()
...
# Distance model
distancemodel = ppy.distancemodels.FixedDistance(31.08)  # fixed dmod=31
