# M31 Model 7 (NonParam, Free, Single)
# Ben Cook (bcook@cfa.harvard.edu)

###############################################
# CONFIG FILE for M31 Model 7
# MODEL Galaxy:
#    Single FeH
#    Single Dust
#    NonParam SFH
...
params['filters'] = ppy.instrument.m31_winter_filters()
...
# Distance model
distancemodel = ppy.distancemodels.FixedDistance(24.44)  # fixed dmod=31
